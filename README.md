...
qDesk Calendar is a module for qDesk. It's accessible across qDesk, you can use it with qDesk Social, qDesk Messages and other qDesk modules.

qDesk Calendar offers the ability to share events and event invitations, as well as to evens publicly posted by peers on the network. qDesk Calendars is connected to [qDesk Social](https://github.com/QuestNetwork/qd-social-js) and uses the station supplied by qDesk Social. 
